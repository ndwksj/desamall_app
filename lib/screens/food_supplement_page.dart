...
class FoodSupplementPage extends StatefulWidget {
  final String outletId;

  const FoodSupplementPage({Key? key, required this.outletId}) : super(key: key);

  @override
  State<FoodSupplementPage> createState() => _FoodSupplementPageState();
}

class _FoodSupplementPageState extends State<FoodSupplementPage> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Text("No supplements match your filter choices.", style: TextStyle(color: Colors.grey)),
                        ],
                      ),
                    ),
                  );
