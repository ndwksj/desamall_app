        ...
        Container(
          ...
          child: Container(
            ...
            child: StreamBuilder<DocumentSnapshot>(
              stream: FirebaseFirestore.instance.collection('admins').doc(currentUser?.uid).snapshots(),
              builder: (context, snapshot) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Text(
                      name, 
                      style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w900, letterSpacing: -0.2)
                    ),
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                "System Operations", 
                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: Color(0xFF1F2A38), letterSpacing: 0.2)
              ),
    ...
    return SizedBox(
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (docs.isEmpty) {
            return const Center(
              child: Text("No linked outlets.", style: TextStyle(color: Color(0xFF8A94A6), fontSize: 13, fontWeight: FontWeight.w600))
            );
          }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        p['name'] ?? "", 
                        style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: Color(0xFF1F2A38)), 
                        maxLines: 1, 
                    ...
                    Padding(
                      ...
                      child: Text(
                        "RM ${p['price']}", 
                        style: const TextStyle(color: Color(0xFFD32F2F), fontSize: 13, fontWeight: FontWeight.w800)
                      ),
                    ),
                  ],
                ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            title, 
            style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: Color(0xFF1F2A38), letterSpacing: 0.2)
          ),
          InkWell(
            onTap: onAction,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                label, 
                textAlign: TextAlign.center,
                style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 11, color: Color(0xFF4A5568))
              ),
            ],
          ),
        ),
                ...
                try {
                  ...
                  if (context.mounted) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text("Outlet Created successfully!"), backgroundColor: Colors.green)
                    );
                  }
                } catch (e) {
                  if (context.mounted) {
