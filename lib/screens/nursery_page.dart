...
class NurseryPage extends StatelessWidget {
  ...
  const NurseryPage({Key? key, required this.outletId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Keperluan Bayi', 
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      "assets/images/nursery_background.png",
                      fit: BoxFit.cover, 
                      errorBuilder: (c, e, s) => Container(
                        color: Colors.redAccent.withOpacity(0.1),
                        child: const Icon(Icons.child_care, size: 50, color: Colors.redAccent),
                      ),
                    ),
                  ),
                ),
                ...
                const Positioned(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Bayi dan Kanak-Kanak", style: TextStyle(color: Colors.white70, fontSize: 14)),
                      Text(
                        "Keperluan Bayi",
            ...
            const Padding(
              ...
              child: Text("Essential Care", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ),

            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('products')
                  .where('category', isEqualTo: 'Nursery Page') 
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.stroller_outlined, size: 70, color: Colors.grey.shade300),
  ...
  Widget _buildProductImage(String path) {
    if (path.isEmpty) return const Icon(Icons.child_friendly_rounded, size: 40, color: Colors.redAccent);
